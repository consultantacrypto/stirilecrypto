...
import { Crown, ArrowRight, FileText, Zap, Star } from 'lucide-react';
import Image from 'next/image';

const BOOKING_URL = 'https://www.mihaidaniel.ro/';
...
export default function Consultancy() {
  ...
  return (
    <section id="consultanta" className="py-24 bg-[#050b1d] border-t border-white/5 relative overflow-hidden">
      <div className="absolute right-0 bottom-0 w-[600px] h-[600px] bg-yellow-600/5 rounded-full blur-[150px] pointer-events-none" />
          ...
          <div className="flex-1 space-y-8">
            ...
            <p className="text-xl text-gray-300 leading-relaxed border-l-4 border-yellow-500/50 pl-6">
              ...
              <span className="block mt-2 text-white font-bold">
                Nu discutăm teorie. Discutăm banii tăi.
              </span>
            </p>
            ...
            <div className="bg-gradient-to-br from-[#1a1500] to-black border border-yellow-500/30 p-6 rounded-2xl relative group hover:border-yellow-500/60 transition-colors">
              <div className="absolute top-0 right-0 bg-yellow-600 text-black text-[10px] font-bold px-3 py-1 rounded-bl-xl">
                BONUS GRATUIT ($200)
              </div>
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <div className="text-sm">
                    <span className="text-white font-bold">PDF: Audit ca un VC</span> - Prompt-uri
                    secrete de analiză.
                  </div>
                </li>
              </ul>
            ...
            <div className="relative rounded-2xl overflow-hidden border border-yellow-500/30 shadow-2xl group aspect-[3/4]">
              ...
              <div className="absolute bottom-6 right-6 left-6 bg-[#0a0f1e]/90 backdrop-blur-md p-4 rounded-xl border border-yellow-500/20">
                ...
                <p className="text-xs text-gray-300 italic">
                  &quot;Cea mai bună oră de consultanță. Mi-a salvat portofoliul de o greșeală
                  majoră.&quot;
                </p>
              </div>
            </div>
