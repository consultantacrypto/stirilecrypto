...
Nu vorbim despre ce „ar putea” să se întâmple. Vorbim despre banii tăi și cum îi facem să lucreze mai inteligent.`}
        ...
        <div className="col-span-1 md:col-span-5 flex flex-col items-center justify-center gap-6">
          ...
          <a
            ...
            className="inline-flex w-full md:w-auto max-w-md items-center justify-center bg-white text-black font-bold px-6 py-4 text-sm md:text-base whitespace-normal text-center rounded-xl shadow-[0_0_40px_rgba(56,189,248,0.25)] hover:bg-sky-50 hover:shadow-[0_0_48px_rgba(56,189,248,0.4)] transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-sky-400 leading-snug"
          >
            Rezervă o oră de consultanță crypto cu Mihai Daniel
          </a>
        </div>
      </div>
    </aside>
